  ...
  <div className='pageWrap'>
    ...
    <div className='todoList'>
      <div className='todoList__functions'>
        {todos.map((todo) => <div className='todoList__functions--div' key={todo.id}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input className='todoList__form--input' maxLength={14} placeholder='Nova tarefa...' type="text" onChange={(e) => setTodo(e.target.value)} value={todo}/>
        <button type='submit' className='todoList__form--button'><img src={CrossIcon} alt="" /></button>
      </form>
      <DeleteModal
      className="overlay" 
      open={openModal}
